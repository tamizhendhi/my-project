...
public partial class adminaspx_CabHRvoucher : System.Web.UI.Page
{
    ...
    protected void BindSubjectData()
    {
        ...
        con.Open();
        SqlCommand com4 = new SqlCommand("select * from voucher where status='Verified' and  bookingdate >='" + date + "'", con);
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Accept")
        {
            ...
            SqlCommand com4 = new SqlCommand("UPDATE voucher SET status='Confirmed' WHERE empid=@empid and status='Verified'", con);
        ...
        else if (e.CommandName == "Reject")
        {
            ...
            con.Open();
            string id = (GridView1.Rows[index].Cells[0].Text);
            SqlCommand com4 = new SqlCommand("UPDATE voucher SET status='Rejected' WHERE empid=@empid and status='Verified'", con);
            com4.Parameters.AddWithValue("@empid", id);
            com4.ExecuteNonQuery();
            con.Close();
           GridView1.EditIndex = -1;
    ...
    {
        con.Open();
        SqlCommand com4 = new SqlCommand("UPDATE voucher SET status='Confirmed' WHERE status='Verified'", con);
        com4.ExecuteNonQuery();
        con.Close();
        GridView1.EditIndex = -1;
        BindSubjectData();
    ...
    {
        con.Open();
        SqlCommand com4 = new SqlCommand("UPDATE voucher SET status='Rejected' WHERE status='Verified'", con);
        com4.ExecuteNonQuery();
        con.Close();
        GridView1.EditIndex = -1;
        BindSubjectData();
