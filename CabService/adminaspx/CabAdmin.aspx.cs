...
public partial class adminaspx_CabAdmin : System.Web.UI.Page
{
    ...
    protected void BindSubjectData()
    {
        ...
        con.Open();
        SqlCommand com4 = new SqlCommand("select * from booking where (status='Requested' and pmanager='"+pm+"')and  bookingdate >='"+date+"'", con);
    ...
    {
        con.Open();
        SqlCommand com4 = new SqlCommand("UPDATE booking SET status='Confirmed' WHERE status='Requested'", con);
        com4.ExecuteNonQuery();
        con.Close();
        GridView1.EditIndex = -1;
        BindSubjectData();
    ...
    {
        con.Open();
        SqlCommand com4 = new SqlCommand("UPDATE booking SET status='Rejected' WHERE status='Requested'", con);
        com4.ExecuteNonQuery();
        con.Close();
        GridView1.EditIndex = -1;
        BindSubjectData();
