<%@ Page Title="" Language="C#" MasterPageFile="~/master/CabAdminMaster.master" AutoEventWireup="true" CodeFile="CabVoucherReport.aspx.cs" Inherits="adminaspx_CabVoucherReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server"> <link href="../css/CabReport.css" rel="stylesheet" />
</asp:Content>
