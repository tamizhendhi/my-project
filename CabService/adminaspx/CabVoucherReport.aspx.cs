...
public partial class adminaspx_CabVoucherReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand com4 = new SqlCommand("select * from voucher where('" + atype + "'='Admin' or pmanager='" + pm + "' or '" + atype + "'='Human Resource')and bookingdate >='" + date + "' ", con);
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        if (txtDetailstdate.Text != "" && txtDetailenddate.Text != "")
        {
            ...
            con.Open();
            SqlCommand com = new SqlCommand("select count(*) from voucher where('" + atype + "'='Admin' or pmanager='" + pm + "' or '" + atype + "'='Human Resource') and  bookingdate >='" + txtDetailstdate.Text + "' and bookingdate <='" + txtDetailenddate.Text + "' ", con);
            ...
            if (row != 0)
            {
                SqlCommand com4 = new SqlCommand("select * from voucher where ('" + atype + "'='Admin' or pmanager='" + pm + "' or '" + atype + "'='Human Resource') and  bookingdate >='" + txtDetailstdate.Text + "' and bookingdate <='" + txtDetailenddate.Text + "' ", con);
