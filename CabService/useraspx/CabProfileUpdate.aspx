       ...
       <table>
           ...
           <tr>
            ...
            <tr>
               ...
               <td><asp:DropDownList ID="DrpTec" runat="server" OnSelectedIndexChanged="DrpTec_SelectedIndexChanged" AutoPostBack="true">
                        <asp:ListItem>select</asp:ListItem>
           ...
           <tr>
               ...
               <td><asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Enter TEN digit Mobile no" EnableViewState="True" ControlToValidate="txtPhone" ValidationExpression="[0-9]{10}"></asp:RegularExpressionValidator></td>
           </tr>
